...
class DarGreenText : public Text
{
public:
	DarGreenText(HANDLE hConsole)
	{
	...
	{
		SetConsoleTextAttribute(hConsole, 242);
		cout << "This is the default font for the light theme" << endl;
	}
};
...
public:
	...
	{
		return new DarGreenText(hConsole);
	}
};
...
int main()
{
	...
	if (app != NULL)
	{
		...
		Text* Greentext = app->getGreenText(hConsole);
		appDefaultText->message(hConsole);
		Greentext->message(hConsole);
